...
import framework.db
from models.network import Base
from api import health, info, network
...
app = FastAPI(
    title="Network API",
    version="1.0.0",
    openapi_url="/api/v1/network/openapi.json",
    docs_url="/api/v1/network/docs",
    lifespan=lifespan
)
...
app.mount("/network/test", StaticFiles(directory="static", html=True), name="test")
